...
if __name__ == "__main__":
    ...
    run_table_column_job('example/sample_data/mi_tabla_inegi.csv', 'example/sample_data/inegi_col.csv')
    run_table_badge_job('example/sample_data/mi_tabla_inegi.csv', 'example/sample_data/sample_badges.csv')
