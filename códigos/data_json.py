...
if __name__ == "__main__":
    ...
    run_table_column_job('example/sample_data/data_inegi_table.csv', 'example/sample_data/data_inegi_col.csv')
    ...
    run_csv_job('example/sample_data/data_inegi_owner.csv', 'test_table_owner_metadata',
